...
public:
	...
	reflectObject(void (*init)(reflectObject*), reflectObject* _super) {
...
unsigned char reflectObject::reflation[20][20] = {};
int reflectObject::refl_index = 0;
//bool** map = nullptr;
//
...
reflectObject type::reflect { &type::initTypeDescriptor, TypeResolver<type::super>::get() }; \
reflectObject* type::getReflector() { return &reflect; } \
...
template<typename T>
bool isCastable(T* _a, reflectObject* _b) {
